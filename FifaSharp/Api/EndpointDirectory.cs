...
{
    public const int GAME_YEAR = 27;
    public const string HOSTNAME = "utas.mob.v5.prd.futc-ext.gcp.ea.com";
    public const string BASE_URL = $"{HOSTNAME}/ut/game/fc27";
    public const string CLIENT_ID = "FC27_JS_WEB_APP";
